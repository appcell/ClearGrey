...

{
	...
	{
		jQuery("#footer-container-bg").css("margin-top","-5em");
		jQuery("div.triangle-l").css("top","28px");
	}
	else
	{
		jQuery("div.triangle-l").css("top","27px");
		if(bro.msie&&bro.version<9)
		{
			jQuery("#footer-container-bg").css("top","-5em");
		}
		else
		{
			if(bro.msie)
	...
	var banner_img=jQuery("#banner img");
	var wid=banner_img.width();
	banner_img.css("width",wid.toString()+"px");
	banner_img.css("left","-10px");
