...
<div class="itemHeaderWrapper">
  ...
  <div class="itemToolbar hidden-phone">
		...
		<!-- Date created -->
		<!--<div class="itemDateWrapper">
			<span class="itemDateCreated day">
				<?php echo JHTML::_('date', $this->item->created , JText::_('d')); ?>
			</span>
			<span class="itemDateCreated month">
  ...
  <div class="itemBody">
	  ...
	  <!-- Item introtext -->
	<div class="itemIntroTextWrapper">
	...
	<div class="itemSocialSharing">
		...
		<div style="float: left;"><wb:share-button count="n" size="middle" ></wb:share-button></div>
  ...
  <div class="itemLinks">
		...
		<div class="itemCategory">
			<span><img src="templates/clear_grey/images/icon_category.png"/></span>
	  ...
	  <div class="itemTagsBlock">
		  <span><img src="templates/clear_grey/images/icon_tag.png"/></span>
		  <ul class="itemTags">
  ...
  <div class="itemAuthorBlock">
    ...
    <div class="itemAuthorDetails">
      <span class="itemColumnTitleWrapper"><h3 class="itemAuthorName">
      	<a rel="author" href="<?php echo $this->item->author->link; ?>"><?php echo $this->item->author->name; ?></a>
      </h3></span>
 ...
 <?php if($this->item->params->get('itemAuthorLatest') && empty($this->item->created_by_alias) && isset($this->authorLatestItems)): ?>
  <!-- Latest items from author -->
	<div class="itemAuthorLatest" style="width: <?php if (isset($this->relatedItems)) echo "48%"; else echo "100%"; ?> ;">
		<span class="itemColumnTitleWrapper"><h3><?php echo JText::_('K2_LATEST_FROM'); ?> <?php echo $this->item->author->name; ?></h3></span>
		<ul style="<?php if(htmlspecialchars($this->language)!='en-GB') echo 'font-size: 1.2em;'; ?>">
  ...
  <!-- Related items by tag -->
	<div class="itemRelated" style="width: <?php if (isset($this->authorLatestItems)) echo "48%"; else echo "100%"; ?> ;">
		<span class="itemColumnTitleWrapper"><h3><?php echo JText::_("K2_RELATED_ITEMS_BY_TAG"); ?> </h3></span>
		<ul style="<?php if(htmlspecialchars($this->language)!='en-GB') echo 'font-size: 1.2em;'; ?>">
  ...
  <div class="itemVideoBlock">
  	<span class="itemColumnTitleWrapper"><h3><?php echo JText::_('K2_MEDIA'); ?></h3></span>
  ...
  <div class="itemImageGallery">
	  <span class="itemColumnTitleWrapper"><h3><?php echo JText::_('K2_IMAGE_GALLERY'); ?></h3></span>
 ...
 <?php if($this->item->params->get('itemComments') && ($this->item->params->get('comments') == '1' || ($this->item->params->get('comments') == '2')) && empty($this->item->event->K2CommentsBlock)): ?>
  ...
  <div class="itemComments">
	  ...
	  <!-- Item user comments -->
	  	<span class="itemColumnTitleWrapper itemCommentsCounterSpan"><h3 class="itemCommentsCounter">
	  	<span><?php echo $this->item->numOfComments; ?></span> <?php echo ($this->item->numOfComments>1) ? JText::_('K2_COMMENTS') : JText::_('K2_COMMENT'); ?>
	 </h3></span>

	  <ul class="itemCommentsList" style="<?php if(htmlspecialchars($this->language)!='en-GB') echo 'font-size: 1.2em;'; ?>">
	    ...
	    <li class="<?php echo ($key%2) ? "odd" : "even"; echo (!$this->item->created_by_alias && $comment->userID==$this->item->created_by) ? " authorResponse" : ""; echo($comment->published) ? '':' unpublishedComment'; ?>">
		    ...
		    <span class="commentAuthorName">
		    	...
		    	<?php echo JHTML::_('date', $comment->commentDate, JText::_('m-d-Y')); ?>
		    </span>
