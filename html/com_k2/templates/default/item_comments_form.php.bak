...
<span class="itemColumnTitleWrapper"><h3><?php echo JText::_('K2_LEAVE_A_COMMENT') ?></h3></span>
...
<form action="<?php echo JRoute::_('index.php'); ?>" method="post" id="comment-form" class="form-validate">
	...
	<div class="itemCommentOthersWrapper">
	...
	<div class="itemCommentTextWrapper">
	...
	<div class="nofloat"><input type="submit" class="button" id="submitCommentButton" value="<?php echo JText::_('K2_SUBMIT_COMMENT'); ?>" />
