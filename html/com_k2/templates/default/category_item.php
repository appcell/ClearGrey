...
<div class="catItemView row-fluid <?php echo ($this->item->featured) ? ' catItemIsFeatured' : ''; ?><?php if($this->item->params->get('pageclass_sfx')) echo ' '.$this->item->params->get('pageclass_sfx'); ?>">
	...
	<div class="catItemRatingBlock">
		...
		<div class="itemRatingForm">
			<ul class="itemRatingList">
				<li class="itemCurrentRating" id="itemCurrentRating<?php echo $this->item->id; ?>" ></li>
	...
	<div class="catItemHeader">
		<div class="catItemTitleWrapper">
		  ...
		  <h4 class="catItemTitle">
			...
			<!-- Date created -->
				<span class="catItemDateCreated day">
