...
<div id="k2ModuleBox<?php echo $module->id; ?>" class="k2ItemsBlock<?php if($params->get('moduleclass_sfx')) echo ' '.$params->get('moduleclass_sfx'); ?>"  >
	...
	<span class="k2modulePretext-top"><p><a class="moduleCustomLink" href="<?php echo $params->get('itemCustomLinkURL'); ?>" title="<?php echo K2HelperUtilities::cleanHtml($itemCustomLinkTitle); ?>">
<?php echo $params->get('itemPreText'); ?></a></p><span class="k2moduleImage-top"></span></span>
  ...
  <ul>
    ...
    <li class="<?php echo ($key%2) ? "odd" : "even"; if(count($items)==$key+1) echo ' lastItem'; ?>">
      ...
      <span class="moduleItemDateCreated"><?php echo JHTML::_('date', $item->created, JText::_('[m-d-Y]')); ?></span>
      <?php endif; ?>
