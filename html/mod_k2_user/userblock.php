...
<div id="k2ModuleBox<?php echo $module->id; ?>" class="k2UserBlock<?php if($params->get('moduleclass_sfx')) echo ' '.$params->get('moduleclass_sfx'); ?>">
  ...
  <ul class="k2UserBlockActions">
		...
		<li class="span4 useractionblock">
	...
	<!--<ul class="k2UserBlockRenderedMenu">-->
		...
		<li class="linkItemId<?php echo $link->id; ?> span4 useractionblock">
		...
		<li class="linkItemId span4 useractionblock">
			<a class="modal" rel="{handler:'iframe',size:{x:1024,y:750}}" href="./administrator/index.php?option=com_contact&view=contact&layout=edit">添加研究人员</a>		
		</li>
		<li class="linkItemId span4 useractionblock">
			<a target="_blank" href="./administrator/">后台管理</a>		
		</li>
  </ul>
