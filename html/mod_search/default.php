...
<form action="<?php echo JRoute::_('index.php');?>" method="post">
	<div class="search<?php echo $moduleclass_sfx ?>">
		<?php
			...
			if ($button) :
				if ($imagebutton) :
					$button = '<input type="image" id="mod-search-button" value="'.$button_text.'" class="button'.$moduleclass_sfx.'" src="templates/clear_grey/images/searchButton.png" onclick="this.form.searchword.focus();"/>';
				else :
